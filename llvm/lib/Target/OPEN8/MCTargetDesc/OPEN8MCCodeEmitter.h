//===-- OPEN8MCCodeEmitter.h - Convert OPEN8 Code to Machine Code -------------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines the OPEN8MCCodeEmitter class.
//
//===----------------------------------------------------------------------===//
//

#ifndef LLVM_OPEN8_CODE_EMITTER_H
#define LLVM_OPEN8_CODE_EMITTER_H

#include "OPEN8FixupKinds.h"
...
/// Writes OPEN8 machine code to a stream.
class OPEN8MCCodeEmitter : public MCCodeEmitter {
public:
  OPEN8MCCodeEmitter(const MCInstrInfo &MCII, MCContext &Ctx)
      : MCII(MCII), Ctx(Ctx) {}
...
private:
  ...
  OPEN8MCCodeEmitter(const OPEN8MCCodeEmitter &) = delete;
  void operator=(const OPEN8MCCodeEmitter &) = delete;
...
#endif // LLVM_OPEN8_CODE_EMITTER_H
