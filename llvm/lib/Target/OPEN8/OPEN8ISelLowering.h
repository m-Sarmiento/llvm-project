//===-- OPEN8ISelLowering.h - OPEN8 DAG Lowering Interface ----------*- C++ -*-===//
//
...
#ifndef LLVM_OPEN8_ISEL_LOWERING_H
#define LLVM_OPEN8_ISEL_LOWERING_H
...
enum NodeType {
  ...
  /// OPEN8 conditional branches. Operand 0 is the chain operand, operand 1
...
} // end of namespace OPEN8ISD

class OPEN8Subtarget;
class OPEN8TargetMachine;

/// Performs target lowering for the OPEN8.
class OPEN8TargetLowering : public TargetLowering {
public:
  explicit OPEN8TargetLowering(const OPEN8TargetMachine &TM,
...
private:
  SDValue getOPEN8Cmp(SDValue LHS, SDValue RHS, ISD::CondCode CC, SDValue &OPEN8cc,
                    SelectionDAG &DAG, SDLoc dl) const;
  SDValue getOPEN8Cmp(SDValue LHS, SDValue RHS, SelectionDAG &DAG,
                    SDLoc dl) const;
...
protected:
  ...
  const OPEN8Subtarget &Subtarget;
...
#endif // LLVM_OPEN8_ISEL_LOWERING_H
