; RUN: llc < %s -march=open8 -filetype=asm `| FileCheck %s -check-prefix=CHECK-ASM`
; RUN: llc < %s -march=avr -filetype=obj | llvm-objdump -Dr - `| FileCheck %s` -check-prefix=CHECK-OBJ`
; XFAIL: *
